...
```
constructor(audioConfig: object, sfxConfig: object, bgmConfig: object, noteCalculator: NoteFrequencyCalculator, defaultEnvelope?: object)
...
playSFX(name: string, freqOverride?: string | number): void
...
classDiagram
    ...
    class AudioEngine {
        ...
        -number bgmVol
        -number sfxVol
        +constructor(audioConfig, sfxConfig, bgmConfig, noteCalc, defaultEnvelope)
        +playSFX(name, freqOverride) void
